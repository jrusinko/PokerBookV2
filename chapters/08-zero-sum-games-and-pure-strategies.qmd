...
1. **Constant–Sum Games**
   ...
   We say that two normal–form games are **strategically equivalent**
   if, for every player, the relative payoff comparisons between that
   player’s strategies are the same in both games, holding the other
   players’ strategies fixed.

   More precisely, two games are strategically equivalent if, for each
   player \(i\):

   - Fix any profile of opponents’ strategies \(s_{-i}\).
   - Take any two of player \(i\)’s strategies, \(s_i\) and \(s_i'\).
   - The payoff difference
     \[
     u_i(s_i,s_{-i}) - u_i(s_i',s_{-i})
     \]
     has the same sign and magnitude in both games.

   In particular, best responses and equilibrium structure are preserved.

   (a) Prove that every constant–sum two–player game is strategically
